...
export const HOST_MESSAGES: Record<Locale, Partial<Record<HostMessageKey, string>>> = {
  "pt-BR": {
    ...
    "gate.securitySuffix": " · segurança: {count} aviso(s) do SAST (não bloqueiam).",
    ...
    "gate.part.security": "{count} de segurança (SAST)",
  ...
  en: {
    ...
    "gate.securitySuffix": " · security: {count} SAST advisory(ies) (non-blocking).",
    ...
    "gate.part.security": "{count} security (SAST)",
  ...
  es: {
    ...
    "gate.securitySuffix": " · seguridad: {count} aviso(s) de SAST (no bloquean).",
    ...
    "gate.part.security": "{count} de seguridad (SAST)",
    "gate.part.undefinedName": "{count} de símbolo-fantasma (ruff F821/F822/F823)",
